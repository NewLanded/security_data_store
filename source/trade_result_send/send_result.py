...
def send_bs_result():
    ...
    for result_dict in unsent_result:
        ...
        result_dict["success_rate_3_day"] = tactics_code_success_rate.get(tactics_code, {}).get("success_rate_3_day", 0)
        result_dict["success_rate_5_day"] = tactics_code_success_rate.get(tactics_code, {}).get("success_rate_5_day", 0)
        result_dict["success_rate_7_day"] = tactics_code_success_rate.get(tactics_code, {}).get("success_rate_7_day", 0)
        result_dict["gain_loss_3_day"] = tactics_code_success_rate.get(tactics_code, {}).get("gain_loss_3_day", 0)
        result_dict["gain_loss_5_day"] = tactics_code_success_rate.get(tactics_code, {}).get("gain_loss_5_day", 0)
        result_dict["gain_loss_7_day"] = tactics_code_success_rate.get(tactics_code, {}).get("gain_loss_7_day", 0)
    ...
    unsent_result_str += "code".ljust(10, " ") + "b_point".ljust(10, " ") + "s_point".ljust(10, " ") + "quantity".ljust(10, " ") + "tactics_code".ljust(
        ...
        20, " ") + "gain_loss_5_day".ljust(20, " ") + "gain_loss_7_day".ljust(20, " ") + "<br>"
    result_id = []
    ...
    if unsent_result:
        for result_dict in unsent_result:
            ...
            unsent_result_str += str(result_dict["code"]).ljust(10, " ") + str(result_dict["b_point"]).ljust(10, " ") + str(
                ...
                result_dict["gain_loss_5_day"]).ljust(20, " ") + str(result_dict["gain_loss_7_day"]).ljust(20, " ") + "<br>"
